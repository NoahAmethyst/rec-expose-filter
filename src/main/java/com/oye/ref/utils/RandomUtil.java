...
public class RandomUtil extends Random {
    ...
    public static int getRandomRange(int max) {
        return RandomUtil.getRandomRange(max, 0);
    }
    ...
    public static <T> T getRandomItem(List<T> list) {
        ...
        int randomInt = RandomUtil.getRandomRange(list.size());
     ...
     * @return
     */
    public static <T> List<T> getRandomItems(List<T> list, int limit) {
        ...
        List<T> temp = new ArrayList(Arrays.asList(new Object[list.size()]));
        Collections.copy(temp, list);

        int randomInt;
        for (int i = 0; i < limit; i++) {
            randomInt = RandomUtil.getRandomRange(temp.size());
            result.add(temp.remove(randomInt));
        }
